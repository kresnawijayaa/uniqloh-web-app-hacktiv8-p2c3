  ...
  <section id="login-section">
    <section class="bg-white">
      <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
        <main
          class="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-4 lg:px-16 lg:py-12"
        >
            ...
            >
              ...
              <div class="col-span-12">
                <p class="mt-4 text-sm text-gray-500 sm:mt-0 text-center">
                  ...
                  <RouterLink to="/register" class="text-gray-700 underline"
                    >Sign Up</RouterLink
                  >.
                </p>
              </div>
        ...
        <section
          class="relative flex h-32 items-end bg-black lg:col-span-8 lg:h-full"
        >
          <img
            alt="Night"
            src="../assets/medium-shot-happy-women.jpg"
